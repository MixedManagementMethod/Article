...
Objective and Key Results (OKRs) are a conventional terminology for a simple concept, that's lightweight in use and adaptable to changing conditions.
...
. [.listitemterm]#Track as `Objective` tickets# in a <<adopt-our-task-tracking-template,`Strategy` backlog>>.
