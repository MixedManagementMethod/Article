...
As asserted in our <<../Framework#framework,framework>>, 'people' is the root element of any organization.
...
The best possible decisions are made more likely by a <<../Practice/Decision Making#decision-making,discursive process prior to the decision>>.
...
* [.listitemterm]#An organization-wide <<../Practice/IT Infrastructure and Tools#adopt-task-tracking-ticketing-for-all,task tracking (ticketing) system>>#. The history is captured in the ticket fields, particularly the comments, where notes of thoughts and actions should be kept.
...
* Right people: <<Individual Performance#individual-performance,Individual Performance>>
* Right positions: <<Organizational Structure#organizational-structure,Organizational Structure>>
* Right numbers: <<Organizational Structure#staff-in-adequate-numbers-for-your-expectations,Staff in adequate numbers for your expectations>>
...
* Anything else disconnected from <<Individual Performance#individual-performance, individual performance>>.
