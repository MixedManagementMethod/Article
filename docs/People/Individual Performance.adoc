...
How does character manifest? Ultimately, as a set of anecdotes that describe the actions an individual took in a specific scenario. This may be captured internally as <<../Practice/IT Infrastructure and Tools#adopt-task-tracking-ticketing-for-all,a set of tickets>>.
